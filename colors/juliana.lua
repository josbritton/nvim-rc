...
function M.blend(fg, bg, alpha)
    local bg = M.hexToRgb(bg)
    local fg = M.hexToRgb(fg)
...
function M:load()
    ...
    hl("DiagnosticUnderlineHint", { undercurl = true, sp = C.cyan1 })
    ...
    hl("DiagnosticUnderlineInfo", { undercurl = true, sp = C.green })
    ...
    hl("DiagnosticUnderlineWarn", { undercurl = true, sp = C.yellow1 })
    hl("DiagnosticUnnecessary", { undercurl = true, sp = C.magenta, fg = C.fg3 })
    hl("DiagnosticVirtualTextWarn", { fg = C.yellow1, bg = "NONE" })
    hl("DiagnosticUnderlineOk", { underline = true, sp = C.green, fg = "NONE" })
    ...
    hl("TreesitterContext", { link = "StatusLineNC" })
    hl("TreesitterContextLineNumber", { link = "TreesitterContext" })
    hl("TreesitterContextBottom", { underline = true, sp = C.fg4 })
    hl("TreesitterContextLineNumberBottom", { underline = true, sp = C.fg4 })
